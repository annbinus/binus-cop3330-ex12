...
public class ComputingSI {
    public static void main(String[] args) {
        ...
        double simpleInterest = principal*(1 + rate/100*year);

        System.out.println("After " + year + " years at " + rate + "%, the investment will be worth $" + (double)Math.round(simpleInterest*100)/100 + ".");
    }
}
